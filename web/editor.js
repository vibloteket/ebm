...
TILE_CLASS = MyTile
`;
const ids=["tile-select","route-select","status","validation-results","draft-state","cursor-position","preview","loading","tile-title","tile-id","tile-author","tile-origin","console-output","console-count"];
