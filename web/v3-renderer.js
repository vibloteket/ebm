(() => {
  ...
  void main(){
    ...
    outColor=vec4(materialColor.rgb,alpha*materialColor.a);
  }`;
  ...
  window.renderV3Tile = (segments, circles, seed = 1, cssSize = 228, scale = 1, color = [0.075,0.19,0.49,1]) => {
